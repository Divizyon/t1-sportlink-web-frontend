    ...
    try {
      ...
      if (savedEvents) {
        ...
        const foundEvent = events.find(
          (e) => String(e.id) === unwrappedParams.id
        );
        if (foundEvent) {
          setEvent({
            ...foundEvent,
        ...
        >
                          ...
                          <TableCell>
                            <div className="flex space-x-2">
                              <Button variant="outline" size="sm" asChild>
                                <Link
                                  href={`/dashboard/users/${participant.id}`}
                                >
          ...
          <TabsContent value="reports">
            <Card>
              <CardHeader>
                <CardTitle>
                  Raporlar ve Şikayetler ({event?.reports?.length || 0})
                </CardTitle>
                <CardDescription>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bu işlem geri alınamaz. Bu etkinlik sistemden kalıcı olarak
              silinecek ve tüm kayıtlar ve veriler kaybolacaktır.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

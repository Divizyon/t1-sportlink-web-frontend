...
export function ReportsModal({ 
  ...
  const [selectedReport, setSelectedReport] = useState<EventReport | UserReport | null>(null)
  ...
  const handleReportStatusChange = (newStatus: "resolved" | "dismissed") => {
    if (activeTab === "events") {
      setEventReports(prev => 
        prev.map(report => 
    ...
    toast.success(newStatus === "resolved" ? "Rapor çözüldü olarak işaretlendi" : "Rapor reddedildi")
  }
      ...
      {selectedReport && (
        <ReportDetailModal
          ...
          report={{
            ...
            title: activeTab === "events" ? selectedReport.eventTitle : selectedReport.userName,
            reporter: {
            ...
            reportedItem: {
              id: activeTab === "events" ? selectedReport.eventId : selectedReport.userId,
              name: activeTab === "events" ? selectedReport.eventTitle : selectedReport.userName,
              avatar: activeTab === "events" ? undefined : selectedReport.userAvatar,
              date: activeTab === "events" ? selectedReport.eventDate : undefined,
              email: activeTab === "users" ? selectedReport.userEmail : undefined
            },
